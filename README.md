...
Some things I've built and how I think: 

- **Appointments**. I wrote the internal agenda/appointment system in raw PHP and SQL (no frameworks) serving a company with 120+ employees. It saved the company from operational chaos. Previously they were running on Google Calendar + Excel and to quote them "it was a mess". I was very happy with the immediate adoption and frequent usage. What makes me proud, they depend on it entirely (to this day), that any incorrect logic would immediately affect the whole company and there would be serious troubles with clients. And that has never happened. I enjoy these responsibilities, it's where I give my best. Since then, I've been fascinated with time-related algorithms, which is what led me, years later and faced with a similar problem, to formalize some aspects of this problem into a spec.
